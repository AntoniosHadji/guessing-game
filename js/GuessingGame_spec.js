...
describe('generateWinningNumber function', function() {
  it('returns a random number between 1 and 100', function() {
    ...
    //There is a tiny chance that Math.random will return 0.
...
describe('Game class', function() {
  ...
  describe('Methods on the Game Constructor Function`s `.prototype`', function() {
    ...
    xdescribe('Hint function returns only valid guesses', function() {
      var game;
      ...
      xit('it returns a guess between last guess and next closest guess beyond' +
